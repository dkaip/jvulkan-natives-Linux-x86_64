...
namespace jvulkan
{
            ...
            std::vector<void *> *memoryToFree)
    {
        ...
        ////////////////////////////////////////////////////////////////////////
        jobject pNextObject = getpNextObject(env, jVkAttachmentDescription2KHRObject);
        if (env->ExceptionOccurred())
        {
        ...
        ////////////////////////////////////////////////////////////////////////
        methodId = env->GetMethodID(vkAttachmentDescription2KHRClass, "getFormat", "()Lcom/CIMthetics/jvulkan/VulkanCore/Enums/VkFormat;");
        if (env->ExceptionOccurred())
        {
            return;
        }
        ...
        ////////////////////////////////////////////////////////////////////////
        methodId = env->GetMethodID(vkAttachmentDescription2KHRClass, "getSamples", "()Lcom/CIMthetics/jvulkan/VulkanCore/Enums/VkSampleCountFlagBits;");
        if (env->ExceptionOccurred())
        {
            return;
        }
        ...
        ////////////////////////////////////////////////////////////////////////
        methodId = env->GetMethodID(vkAttachmentDescription2KHRClass, "getLoadOp", "()Lcom/CIMthetics/jvulkan/VulkanCore/Enums/VkAttachmentLoadOp;");
        if (env->ExceptionOccurred())
        {
            return;
        }
        ...
        ////////////////////////////////////////////////////////////////////////
        methodId = env->GetMethodID(vkAttachmentDescription2KHRClass, "getStoreOp", "()Lcom/CIMthetics/jvulkan/VulkanCore/Enums/VkAttachmentStoreOp;");
        if (env->ExceptionOccurred())
        {
            return;
        }
        ...
        ////////////////////////////////////////////////////////////////////////
        methodId = env->GetMethodID(vkAttachmentDescription2KHRClass, "getStencilLoadOp", "()Lcom/CIMthetics/jvulkan/VulkanCore/Enums/VkAttachmentLoadOp;");
        if (env->ExceptionOccurred())
        {
            return;
        }
        ...
        ////////////////////////////////////////////////////////////////////////
        methodId = env->GetMethodID(vkAttachmentDescription2KHRClass, "getStencilStoreOp", "()Lcom/CIMthetics/jvulkan/VulkanCore/Enums/VkAttachmentStoreOp;");
        if (env->ExceptionOccurred())
        {
            return;
        }
        ...
        ////////////////////////////////////////////////////////////////////////
        methodId = env->GetMethodID(vkAttachmentDescription2KHRClass, "getInitialLayout", "()Lcom/CIMthetics/jvulkan/VulkanCore/Enums/VkImageLayout;");
        if (env->ExceptionOccurred())
        {
            return;
        }
        ...
        ////////////////////////////////////////////////////////////////////////
        methodId = env->GetMethodID(vkAttachmentDescription2KHRClass, "getFinalLayout", "()Lcom/CIMthetics/jvulkan/VulkanCore/Enums/VkImageLayout;");
        if (env->ExceptionOccurred())
        {
            return;
        }
