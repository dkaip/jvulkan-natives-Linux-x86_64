 ...
 */
/*
 * getVkWin32KeyedMutexAcquireReleaseInfoKHR.cpp
 *
...
namespace jvulkan
{
    void getVkWin32KeyedMutexAcquireReleaseInfoKHR(
            JNIEnv *env,
            jobject jVkWin32KeyedMutexAcquireReleaseInfoKHRObject,
			VkWin32KeyedMutexAcquireReleaseInfoKHR *vkWin32KeyedMutexAcquireReleaseInfoKHR,
            std::vector<void *> *memoryToFree)
    {
        jclass theClass = env->GetObjectClass(jVkWin32KeyedMutexAcquireReleaseInfoKHRObject);
        if (env->ExceptionOccurred())
        {
        	LOGERROR(env, "%s", "Could not get class for jVkWin32KeyedMutexAcquireReleaseInfoKHRObject");
            return;
        }

        ////////////////////////////////////////////////////////////////////////
        VkStructureType sTypeValue = getSType(env, jVkWin32KeyedMutexAcquireReleaseInfoKHRObject);
        if (env->ExceptionOccurred())
        {
        ...
        ////////////////////////////////////////////////////////////////////////
        jobject jpNextObject = getpNextObject(env, jVkWin32KeyedMutexAcquireReleaseInfoKHRObject);
        if (env->ExceptionOccurred())
        {
        ...
        jobject  jAcquireSyncsObject = env->CallObjectMethod(jVkWin32KeyedMutexAcquireReleaseInfoKHRObject, methodId);
        if (env->ExceptionOccurred())
        {
        ...
        jlongArray jAcquireKeysValuesArrayObject = env->CallObjectMethod(jVkWin32KeyedMutexAcquireReleaseInfoKHRObject, methodId);
        if (env->ExceptionOccurred())
        {
        	LOGERROR(env, "%s", "Error calling CallObjectMethod");
            return;
        ...
        jintArray jAcquireTimeoutsValuesArrayObject = env->CallObjectMethod(jVkWin32KeyedMutexAcquireReleaseInfoKHRObject, methodId);
        if (env->ExceptionOccurred())
        {
        	LOGERROR(env, "%s", "Error calling CallObjectMethod");
            return;
        ...
        jobject  jReleaseSyncsObject = env->CallObjectMethod(jVkWin32KeyedMutexAcquireReleaseInfoKHRObject, methodId);
        if (env->ExceptionOccurred())
        {
        	LOGERROR(env, "%s", "Error calling CallObjectMethod");
            return;
        ...
        jlongArray jReleaseKeysValuesArrayObject = env->CallObjectMethod(jVkWin32KeyedMutexAcquireReleaseInfoKHRObject, methodId);
        if (env->ExceptionOccurred())
        {
        	LOGERROR(env, "%s", "Error calling CallObjectMethod");
            return;
        ...
        vkWin32KeyedMutexAcquireReleaseInfoKHR->sType 	= sTypeValue;
        vkWin32KeyedMutexAcquireReleaseInfoKHR->pNext 	= (void *)pNext;
        vkWin32KeyedMutexAcquireReleaseInfoKHR->acquireCount = acquireCount;
        vkWin32KeyedMutexAcquireReleaseInfoKHR->pAcquireSyncs = pAcquireSyncs;
        vkWin32KeyedMutexAcquireReleaseInfoKHR->pAcquireKeys = pAcquireKeys;
        vkWin32KeyedMutexAcquireReleaseInfoKHR->pAcquireTimeouts = pAcquireTimeouts;
        vkWin32KeyedMutexAcquireReleaseInfoKHR->releaseCount = releaseCount;
        vkWin32KeyedMutexAcquireReleaseInfoKHR->pReleaseSyncs = pReleaseSyncs;
        vkWin32KeyedMutexAcquireReleaseInfoKHR->pReleaseKeys = pReleaseKeys;
    }
}
#endif
