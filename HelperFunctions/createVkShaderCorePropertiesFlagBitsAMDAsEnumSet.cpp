 ...
 */
/*
 * createVkShaderCorePropertiesFlagBitsAMDAsEnumSet.cpp
 *
...
namespace jvulkan
{
    ...
    {
        char const *enumClassString = "com/CIMthetics/jvulkan/VulkanExtensions/Enums/VkShaderCorePropertiesFlagBitsAMD";
        char const *enumObjectString = "Lcom/CIMthetics/jvulkan/VulkanExtensions/Enums/VkShaderCorePropertiesFlagBitsAMD;";
         ...
         */
        if ((vkShaderCorePropertiesFlagsAMD &
             !(VK_SHADER_CORE_PROPERTIES_FLAG_BITS_MAX_ENUM_AMD)) != 0)
        {
        	LOGERROR(env, "Unhandled case for vkShaderCorePropertiesFlagsAMD...value is %x", vkShaderCorePropertiesFlagsAMD);
            return nullptr;
        }

        if (vkShaderCorePropertiesFlagsAMD & VK_SHADER_CORE_PROPERTIES_FLAG_BITS_MAX_ENUM_AMD)
        {
            jfieldID fieldId = env->GetStaticFieldID(enumClass, "VK_SHADER_CORE_PROPERTIES_FLAG_BITS_MAX_ENUM_AMD", enumObjectString);
            ...
            if (addResult == false)
            {
            	LOGERROR(env, "%s", "Could not add VK_SHADER_CORE_PROPERTIES_FLAG_BITS_MAX_ENUM_AMD to EnumSet");
                return nullptr;
            }
        }
