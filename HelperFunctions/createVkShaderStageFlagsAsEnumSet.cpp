...
namespace jvulkan
{
    ...
    {
        char const *enumClassString = "com/CIMthetics/jvulkan/VulkanCore/Enums/VkShaderStageFlagBits";
        char const *enumObjectString = "Lcom/CIMthetics/jvulkan/VulkanCore/Enums/VkShaderStageFlagBits;";
