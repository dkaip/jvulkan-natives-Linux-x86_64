...
namespace jvulkan
{
            ...
            std::vector<void *> *memoryToFree)
    {
        ...
        ////////////////////////////////////////////////////////////////////////
        jmethodID methodId = env->GetMethodID(vkAccelerationStructureInfoNVClass, "getpNext", "()J");
        if (env->ExceptionOccurred())
        {
            return;
        }

        jlong pNext = env->CallLongMethod(jVkAccelerationStructureInfoNVObject, methodId);
        if (env->ExceptionOccurred())
        {
            return;
        }
        ...
        ////////////////////////////////////////////////////////////////////////
        methodId = env->GetMethodID(vkAccelerationStructureInfoNVClass, "getType", "()Lcom/CIMthetics/jvulkan/VulkanExtensions/VK11/Enums/VkAccelerationStructureTypeNV;");
        if (env->ExceptionOccurred())
        {
            return;
        }
