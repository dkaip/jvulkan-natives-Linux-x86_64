...
namespace jvulkan
{
            ...
            std::vector<void *> *memoryToFree)
    {
        ...
        {
        	LOGERROR(env, "%s", "jVkGraphicsPipelineCreateInfoCollectionObject is nullptr.");
            return;
        }
        ...
        {
        	LOGERROR(env, "%s", "Could not get class for jVkGraphicsPipelineCreateInfoCollectionObject.");
            return;
        }
        ...
        *graphicsPipelineCreateInfos = (VkGraphicsPipelineCreateInfo *)calloc(numberOfElements, sizeof(VkGraphicsPipelineCreateInfo));
        if (*graphicsPipelineCreateInfos == nullptr)
        {
        	LOGERROR(env, "Could not allocate %d bytes for *graphicsPipelineCreateInfos", numberOfElements *sizeof(VkGraphicsPipelineCreateInfo));
            return;
        }
        ...
        do
        {
            ...
            if (env->ExceptionOccurred())
            {
            	LOGERROR(env, "%s", "Error calling getVkGraphicsPipelineCreateInfo.");
                break;
            }
