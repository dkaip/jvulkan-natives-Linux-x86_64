...
namespace jvulkan
{
            ...
            std::vector<void *> *memoryToFree)
    {
        ...
        jmethodID methodId = env->GetMethodID(vkGraphicsPipelineCreateInfoClass, "getpNext", "()J");
        if (env->ExceptionOccurred())
        {
            return;
        }

        jlong pNext = env->CallLongMethod(jVkGraphicsPipelineCreateInfoObject, methodId);
        if (env->ExceptionOccurred())
        {
            return;
        }
        ...
        ////////////////////////////////////////////////////////////////////////
        methodId = env->GetMethodID(vkGraphicsPipelineCreateInfoClass, "getFlags", "()Ljava/util/EnumSet;");
        if (env->ExceptionOccurred())
        {
            return;
        }
