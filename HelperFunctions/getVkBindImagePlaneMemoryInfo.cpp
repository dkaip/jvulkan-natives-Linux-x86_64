...
namespace jvulkan
{
            ...
            std::vector<void *> *memoryToFree)
    {
        ...
        ////////////////////////////////////////////////////////////////////////
        VkStructureType sTypeValue = (VkStructureType)getSType(env, jVkBindImagePlaneMemoryInfoObject);
        if (env->ExceptionOccurred())
        {
        ...
        ////////////////////////////////////////////////////////////////////////
        jmethodID methodId = env->GetMethodID(theClass, "getPlaneAspect", "()Lcom/CIMthetics/jvulkan/VulkanCore/Enums/VkImageAspectFlagBits;");
        if (env->ExceptionOccurred())
        {
        	LOGERROR(env, "%s", "Could not find method id for getPlaneAspect");
            return;
        }
