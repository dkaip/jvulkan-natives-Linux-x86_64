 ...
 */
/*
 * vkCmdSetDepthWriteEnableEXT.cpp
 *
...
JNIEXPORT void JNICALL Java_com_CIMthetics_jvulkan_VulkanCore_NativeProxies_vkCmdSetDepthWriteEnableEXT
  (JNIEnv *env, jobject, jobject jVkCommandBuffer, jboolean jDepthWriteEnable)
{
    ...
    if (jDepthWriteEnable != 0)
    {
    	depthWriteEnable = true;
    }

    vkCmdSetDepthWriteEnableEXT(commandBufferHandle, depthWriteEnable);
}
