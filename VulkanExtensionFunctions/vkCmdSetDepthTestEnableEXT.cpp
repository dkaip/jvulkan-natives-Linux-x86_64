 ...
 */
/*
 * vkCmdSetDepthTestEnableEXT.cpp
 *
...
JNIEXPORT void JNICALL Java_com_CIMthetics_jvulkan_VulkanCore_NativeProxies_vkCmdSetDepthTestEnableEXT
  (JNIEnv *env, jobject, jobject jVkCommandBuffer, jboolean jDepthTestEnable)
{
    ...
    if (jDepthTestEnable != 0)
    {
    	depthTestEnable = true;
    }

    vkCmdSetDepthTestEnableEXT(commandBufferHandle, depthTestEnable);
}
