    ...
    void* userData)
{
    ...
    jclass enumClass = localEnv->FindClass("com/CIMthetics/jvulkan/VulkanExtensions/Enums/VkDebugReportFlagBitsEXT");
    ...
    {
        jfieldID fieldId = localEnv->GetStaticFieldID(enumClass, "VK_DEBUG_REPORT_INFORMATION_BIT_EXT", "Lcom/CIMthetics/jvulkan/VulkanExtensions/Enums/VkDebugReportFlagBitsEXT;");
    ...
    {
        jfieldID fieldId = localEnv->GetStaticFieldID(enumClass, "VK_DEBUG_REPORT_WARNING_BIT_EXT", "Lcom/CIMthetics/jvulkan/VulkanExtensions/Enums/VkDebugReportFlagBitsEXT;");
        jobject theEnum = localEnv->GetStaticObjectField(enumClass, fieldId);
    ...
    {
        jfieldID fieldId = localEnv->GetStaticFieldID(enumClass, "VK_DEBUG_REPORT_PERFORMANCE_WARNING_BIT_EXT", "Lcom/CIMthetics/jvulkan/VulkanExtensions/Enums/VkDebugReportFlagBitsEXT;");
        jobject theEnum = localEnv->GetStaticObjectField(enumClass, fieldId);
    ...
    {
        jfieldID fieldId = localEnv->GetStaticFieldID(enumClass, "VK_DEBUG_REPORT_ERROR_BIT_EXT", "Lcom/CIMthetics/jvulkan/VulkanExtensions/Enums/VkDebugReportFlagBitsEXT;");
        jobject theEnum = localEnv->GetStaticObjectField(enumClass, fieldId);
    ...
    {
        jfieldID fieldId = localEnv->GetStaticFieldID(enumClass, "VK_DEBUG_REPORT_DEBUG_BIT_EXT", "Lcom/CIMthetics/jvulkan/VulkanExtensions/Enums/VkDebugReportFlagBitsEXT;");
        jobject theEnum = localEnv->GetStaticObjectField(enumClass, fieldId);
...
(JNIEnv *env, jobject, jobject jVkInstance, jobject jVkDebugReportCallbackCreateInfoEXT, jobject jAlternateAllocator, jobject jVkDebugReportCallbackEXT)
{
    ...
    VkStructureType sTypeValue = getSType(env, jVkDebugReportCallbackCreateInfoEXT);
    if (env->ExceptionOccurred())
    {
    	LOGERROR(env, "%s", "Failed trying to get getSType");
        jvulkan::createVkResult(env, VK_RESULT_MAX_ENUM);
    }
    ...
    methodId = env->GetMethodID(vkDebugReportCallbackCreateInfoEXTClass, "getCallbackObject", "()Lcom/CIMthetics/jvulkan/VulkanCore/VkDebugReportCallback;");
    if (env->ExceptionOccurred())
    {
    ...
    debugReportCallbackCreateInfoEXT.sType = sTypeValue;
