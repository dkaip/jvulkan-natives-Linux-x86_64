 ...
 */
/*
 * vkCmdSetDepthBoundsTestEnableEXT.cpp
 *
...
JNIEXPORT void JNICALL Java_com_CIMthetics_jvulkan_VulkanCore_NativeProxies_vkCmdSetDepthBoundsTestEnableEXT
  (JNIEnv *env, jobject, jobject jVkCommandBuffer, jboolean jDepthBoundsTestEnable)
{
    ...
    if (jDepthBoundsTestEnable != 0)
    {
    	depthBoundsTestEnable = true;
    }

    vkCmdSetDepthBoundsTestEnableEXT(commandBufferHandle, depthBoundsTestEnable);
}
