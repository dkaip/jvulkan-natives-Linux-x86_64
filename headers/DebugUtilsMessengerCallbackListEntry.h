...
namespace jvulkan
{
    class DebugUtilsMessengerCallbackListEntry
    {
        ...
        public:
            DebugUtilsMessengerCallbackListEntry(unsigned long long the1stKey, VkDebugUtilsMessengerEXT the2ndKey, jobject objectReference, jobject userData);
            virtual ~DebugUtilsMessengerCallbackListEntry();

            unsigned long long getThe1stKey();
            VkDebugUtilsMessengerEXT getThe2ndKey();
