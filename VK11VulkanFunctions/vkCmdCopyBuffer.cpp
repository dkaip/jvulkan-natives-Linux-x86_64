  ...
  (JNIEnv *env, jobject, jobject jVkCommandBuffer, jobject jSrcVkBuffer, jobject jDstVkBuffer, jobject jVkBufferCopyCollectionObject)
{
    ...
    VkBuffer_T *srcBufferHandle = (VkBuffer_T *)jvulkan::getHandleValue(env, jSrcVkBuffer);
    if (env->ExceptionOccurred())
    {
        return;
    }

    VkBuffer_T *dstBufferHandle = (VkBuffer_T *)jvulkan::getHandleValue(env, jDstVkBuffer);
    if (env->ExceptionOccurred())
    {
        return;
    }
    ...
    {
        jvulkan::getVkBufferCopyCollection(
                env,
