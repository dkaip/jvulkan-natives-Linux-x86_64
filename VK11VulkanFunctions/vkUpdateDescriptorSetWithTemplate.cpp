 ...
 */
/*
 * vkUpdateDescriptorSetWithTemplate.cpp
 *
...
JNIEXPORT void JNICALL Java_com_CIMthetics_jvulkan_VulkanCore_VK11_NativeProxies_vkUpdateDescriptorSetWithTemplate
  (JNIEnv *env, jobject, jobject jVkDevice, jobject jVkDescriptorSet, jobject jVkDescriptorUpdateTemplate, jobject jObjectCollection)
{
    ...
    VkDescriptorSet_T *descriptorSetHandle = (VkDescriptorSet_T *)jvulkan::getHandleValue(env, jVkDescriptorSet);
    if (env->ExceptionOccurred())
    {
    	LOGERROR(env, "%s", "Could not retrieve VkDescriptorSet handle");
        return;
    }
...
// TODO This code is a duplicate from vkCmdPushDescriptorSetWithTemplateKHR.cpp...sort it out.
static void getObjectCollection(
        JNIEnv *env,
        const jobject jObjectCollection,
        void **data,
        ...
        std::vector<void *> *memoryToFree)
{
    ...
    *data = (void *)calloc(1, 1);
    ...
    do
    {
        ...
        if (strcmp(className, "com.CIMthetics.jvulkan.VulkanCore.VK11.Structures.VkDescriptorImageInfo") == 0)
        {
            free(className);
        ...
        else if (strcmp(className, "com.CIMthetics.jvulkan.VulkanCore.VK11.Structures.VkDescriptorBufferInfo") == 0)
        {
            free(className);
        ...
        else if (strcmp(className, "com.CIMthetics.jvulkan.VulkanCore.VK11.Handles.VkBufferView") == 0)
        {
            free(className);
