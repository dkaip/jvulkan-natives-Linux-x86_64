...
JNIEXPORT void JNICALL Java_com_CIMthetics_jvulkan_VulkanCore_VK11_NativeProxies_vkCmdWriteBufferMarkerAMD
  (JNIEnv *env, jobject, jobject jVkCommandBuffer, jobject jVkPipelineStageFlagBits, jobject jVkBuffer, jlong dstOffset, jint marker)
{
